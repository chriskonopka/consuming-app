...
- Runtime values — only types and small pure helpers (e.g. `auditCitation`, `groupCitationsBySource`, `driftGuard`, `toLocalMessage`, `toCitationRect`, `V1_CHAT_LLM_PROVIDER`, persistence-key constants). These are pure and trivially tested.

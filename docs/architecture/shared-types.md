...
| [`citation.ts`](../../shared/types/citation.ts)         | `Citation` (alias of API's `CitationData`), `AuditedCitation`, `CitationAuditStatus`, `SourcePageGroup`, `auditCitation()`, `groupCitationsByPage()`                                                                                                                                     | `features/citations/`                             |
